...
player1idle = Animation("spritesheet/gameplay/idle_pirata.png", 34, True)
player1idle.set_sequence_time(0,34, 60, True)
player1attack = Animation("spritesheet/gameplay/attack_pirata.png", 12, True)
...
player2idle = Animation("spritesheet/gameplay/pepino_idle.png", 36, True)
player2idle.set_sequence_time(0, 35, 60, True)
player2attack = Animation("spritesheet/gameplay/pepino_ataca.png", 11, True)
